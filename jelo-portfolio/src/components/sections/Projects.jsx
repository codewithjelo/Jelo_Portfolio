...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Real-time weather application with location-based forecasts, interactive maps, and detailed weather metrics.",
    ...
    },
    {
      ...
      description: "Modern portfolio website with smooth animations, responsive design, and dark mode support.",
    ...
    },
    {
      ...
      description: "Personal fitness tracking application with workout logging, progress charts, and goal setting features.",
  ...
  return (
    <section id="projects" className="min-h-screen bg-slate-950 py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            A collection of my recent work and personal projects that showcase my skills in web development.
          </p>
        </div>

        {/* Projects Container Card - Scrollable */}
        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-8 md:p-12 shadow-2xl">
          {/* Container Header */}
          ...
          <div className="max-h-[600px] overflow-y-auto pr-4 custom-scrollbar">
            <div className="grid md:grid-cols-2 gap-6">
              {projects.map((project) => (
                <div
                  key={project.id}
                  className="group bg-slate-800/50 rounded-lg overflow-hidden border border-slate-700 hover:border-cyan-500/50 hover:bg-slate-800 transition-all duration-300"
                >
                  {/* Image Carousel */}
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.map((tech, index) => (
                        <span
                          key={index}
                          className="px-2.5 py-1 text-xs bg-slate-900 text-cyan-400 rounded-md border border-slate-700"
                        >
                          {tech}
                        </span>
                      ))}
                    ...
                    <div className="flex gap-3 pt-4 border-t border-slate-700">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 text-slate-400 hover:text-cyan-400 text-sm transition-colors ml-auto"
                      >
                        <span>Live Demo</span>
